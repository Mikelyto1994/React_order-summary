...
const PageWrapper = styled.div`
  background: hsl(225, 100%, 94%) url('/pattern-background-desktop.svg') no-repeat center top;
  ...
  box-sizing: border-box; /* Asegura que el padding no afecte el tamaño total */
    ...
    background: hsl(225, 100%, 94%) url('/pattern-background-mobile.svg') no-repeat center top;
...
const OrderSummaryCard = () => {
    return (
      <PageWrapper>
        <Card>
          <HeroImage src='/illustration-hero.svg' alt="hero" />
          ...
          <PlanContainer>
            <PlanIcon src='/icon-music.svg' alt="music icon" />
            <PlanDetails>
